...
//        loaderCamp.
    ...
    function newsFeed()
    {
        loaderCamp.sourceComponent = newsComponent
        burgermenu.closeNavDrawer()
    ...
    function babyBook()
    {
        loaderCamp.sourceComponent = lilBookComponent
        burgermenu.closeNavDrawer()
    ...
    {
        loaderCamp.sourceComponent = whyTestComponent
        burgermenu.closeNavDrawer()
    ...
    property var pictureArray: ["qrc:/Burger/Raspisanie.tif", "qrc:/Burger/Messenger.tif", "qrc:/Burger/Friends.tif", "qrc:/Burger/Lenta.tif", "qrc:/Burger/Questroom.tif", "qrc:/Burger/Knijka_malyshka.tif", "qrc:/Burger/Pochemuchka.tif","qrc:/Burger/Maps.tif","qrc:/Burger/Cyber_magazine.tif", "qrc:/ach/qrIcon.png"]
