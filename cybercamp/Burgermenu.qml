...
//    height: dfltHeight
    ...
    function loadData(isAut){
        imgAvatar.source=client.getAvatar();
    ...
    function showNavDrawer()
    {
        ...
        //var dasd=client.getCurrentChild()
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Image {
                        ...
                        //source: client.getCurrentChild().getAvatar()
...
//                    text: client.getMyName()
                    ...
                    text: "12"//client.getCurrentChild().getName()
...
//        }
    ...
    Rectangle {
        ...
        Component.onCompleted: {
            client.onAnswerAuthorization.connect(loadData);
        }
}
